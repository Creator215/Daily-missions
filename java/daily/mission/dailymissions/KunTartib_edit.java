...
public class KunTartib_edit {
    public Boolean is_okey = false;
    public String job_title = "";
    public String job_clock = "";
    public String job_minut = "";
    public KunTartib_edit(Boolean is_okey,String job_title,String job_time,String job_minut){
        this.is_okey = is_okey;
        this.job_title = job_title;
        this.job_clock = job_time;
    ...
    public void create(Context context, LinearLayout linearLayout, FrameLayout frameLayout){
        ...
        for_job_title_params.addRule(RelativeLayout.ALIGN_PARENT_START);
